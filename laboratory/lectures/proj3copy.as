...
Timer:            PUSH R1
                  ...
                  ; Nova chamada para a IA do fantasma
                  CALL GhostAI
                  MOV R2, M[DirecaoGhost1]

                  ; Restante do código do timer
                  CMP R2, DOWN
...
;------------------------------------------------------------------------------
;Função de colisão com o fantasma 1
;------------------------------------------------------------------------------
ColisaoGhostPacman:           PUSH    R1
                              ...
                              ;Quando x e y forem iguais as posições resetam
...
Main:			ENI
				...
				CALL PrintarMapa
                            ...
                            MOV M[CURSOR], R1
                            MOV R1,'V'
                            MOV M[IO_WRITE],R1 ;Fantasma na nova posição
